...
def main():
    ...
    with  open('driverip.txt', 'r') as driverip:
        for sline in driverip: # single line from out file is sline
            ...
            # the result is we add a list of driver and ip to the networklists
    ...
    for driveandip in networklists:
        print('SSH to ' + driveandip[1] + ' using driver '
         + driveandip[0])
